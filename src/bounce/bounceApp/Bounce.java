...
public class Bounce extends JPanel {
	...
	private void populateModel() {
		...
		_model.add(new DynamicRectangle(0, 0, 2, 3, 180, 130, "I change color when I bounce", Color.CYAN), root);
		...
		_model.add(new DynamicRectangle(0, 0, 2, 3, 50, 80, Color.RED), child);
